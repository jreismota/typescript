...
let testeArray: Array<String> = ["teste1", "teste2"];
let testeArray2: [String, number] = ["teste1", 1];

testeArray.forEach(element => {
    console.log("Element ");
    console.log(element);
});
...
let filtroVagaEmpresa = arrayVaga.Result.filter(x => x.Vaga.Empresa.Pessoa.Nome === "CAMARA DE DIRIGENTES LOJISTAS DE PATOS DE MINAS");

// filtroVagaEmpresa.forEach(element => {
//     console.log(`Vaga: ${element.Vaga.Nome} - Descrição: ${element.Vaga.DescricaoVaga}`);
// });

for (let i = 0; i < filtroVagaEmpresa.length; i++) {
